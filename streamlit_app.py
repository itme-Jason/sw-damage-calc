...
# --- Inputs ---
benchmark = st.number_input("Target Damage Benchmark", min_value=1000, max_value=10000, step=100, value=6000, key="benchmark_input")
...
if lock:
    ...
    # Add manual calculate trigger
    if st.button("🔁 Calculate" if lock else ""): 
